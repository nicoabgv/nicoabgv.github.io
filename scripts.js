...
const translationBindings = {
    ...
    index: [
        ...
        { selector: '[data-live-project-link="micartaya"]', key: 'hero.live.links.micartaya', type: 'html' },
        ...
        { selector: '[data-live-project-link="ponme"]', key: 'hero.live.links.ponme', type: 'html' },
        ...
        { selector: '#modal-orderya p.text-xs.font-semibold', key: 'modals.orderya.tag' },
        { selector: '#modal-orderya h3', key: 'modals.orderya.title' },
        { selector: '#modal-orderya .mt-6 p:nth-of-type(1)', key: 'modals.orderya.paragraph1', type: 'html' },
        { selector: '#modal-orderya .mt-6 ul li:nth-child(1)', key: 'modals.orderya.bullets.first', type: 'html' },
        { selector: '#modal-orderya .mt-6 ul li:nth-child(2)', key: 'modals.orderya.bullets.second', type: 'html' },
        { selector: '#modal-orderya .mt-6 ul li:nth-child(3)', key: 'modals.orderya.bullets.third', type: 'html' },
        { selector: '#modal-orderya .mt-4', key: 'modals.orderya.next' },
        { selector: '#modal-orderya summary', key: 'modals.orderya.diagram' },
        { selector: '#modal-orderya pre', key: 'modals.orderya.diagramContent', type: 'text' },
        { selector: '#modal-micartaya p.text-xs.font-semibold', key: 'modals.micartaya.tag' },
        { selector: '#modal-micartaya h3', key: 'modals.micartaya.title' },
        { selector: '#modal-micartaya .mt-6 p:nth-of-type(1)', key: 'modals.micartaya.paragraph1', type: 'html' },
        { selector: '#modal-micartaya .mt-6 p:nth-of-type(2)', key: 'modals.micartaya.paragraph2', type: 'html' },
        { selector: '#modal-micartaya .mt-6 ul li:nth-child(1)', key: 'modals.micartaya.bullets.first', type: 'html' },
        { selector: '#modal-micartaya .mt-6 ul li:nth-child(2)', key: 'modals.micartaya.bullets.second', type: 'html' },
        { selector: '#modal-micartaya .mt-6 ul li:nth-child(3)', key: 'modals.micartaya.bullets.third', type: 'html' },
        { selector: '#modal-micartaya .mt-4', key: 'modals.micartaya.next' },
        { selector: '#modal-micartaya summary', key: 'modals.micartaya.diagram' },
        { selector: '#modal-micartaya pre', key: 'modals.micartaya.diagramContent', type: 'text' },
        { selector: '#modal-ponme p.text-xs.font-semibold', key: 'modals.ponme.tag' },
        { selector: '#modal-ponme h3', key: 'modals.ponme.title' },
        { selector: '#modal-ponme .mt-6 p:nth-of-type(1)', key: 'modals.ponme.paragraph1', type: 'html' },
        { selector: '#modal-ponme .mt-6 p:nth-of-type(2)', key: 'modals.ponme.paragraph2', type: 'html' },
        { selector: '#modal-ponme .mt-6 ul li:nth-child(1)', key: 'modals.ponme.bullets.first', type: 'html' },
        { selector: '#modal-ponme .mt-6 ul li:nth-child(2)', key: 'modals.ponme.bullets.second', type: 'html' },
        { selector: '#modal-ponme .mt-6 ul li:nth-child(3)', key: 'modals.ponme.bullets.third', type: 'html' },
        { selector: '#modal-ponme .mt-4', key: 'modals.ponme.next' },
        { selector: '#modal-ponme summary', key: 'modals.ponme.diagram' },
        { selector: '#modal-ponme pre', key: 'modals.ponme.diagramContent', type: 'text' },
    ],
    projects: [
        ...
        { selector: '[data-nav] a[href="#micartaya"]', key: 'nav.micartaya' },
        { selector: '[data-nav] a[href="#orderya"]', key: 'nav.orderya' },
        ...
        { selector: '[data-nav] a[href="#ponme"]', key: 'nav.ponme' },
        ...
        { selector: 'main .rounded-3xl ul li:nth-child(2) a', key: 'hero.indexItems.micartaya', type: 'html' },
        { selector: 'main .rounded-3xl ul li:nth-child(3) a', key: 'hero.indexItems.orderya', type: 'html' },
        { selector: 'main .rounded-3xl ul li:nth-child(4) a', key: 'hero.indexItems.trato', type: 'html' },
        { selector: 'main .rounded-3xl ul li:nth-child(5) a', key: 'hero.indexItems.kobra', type: 'html' },
        { selector: 'main .rounded-3xl ul li:nth-child(6) a', key: 'hero.indexItems.beatlist', type: 'html' },
        { selector: 'main .rounded-3xl ul li:nth-child(7) a', key: 'hero.indexItems.ponme', type: 'html' },
        ...
        { selector: '#micartaya p.text-xs.font-semibold', key: 'micartaya.label' },
        { selector: '#micartaya h2', key: 'micartaya.title' },
        { selector: '#micartaya article p:nth-of-type(1)', key: 'micartaya.paragraph1', type: 'html' },
        { selector: '#micartaya article p:nth-of-type(2)', key: 'micartaya.paragraph2', type: 'html' },
        { selector: '#micartaya h3.text-sm.font-semibold', key: 'micartaya.impact' },
        { selector: '#micartaya article ul li:nth-child(1)', key: 'micartaya.bullets.first', type: 'html' },
        { selector: '#micartaya article ul li:nth-child(2)', key: 'micartaya.bullets.second', type: 'html' },
        { selector: '#micartaya article ul li:nth-child(3)', key: 'micartaya.bullets.third', type: 'html' },
        { selector: '#micartaya aside h3.text-sm.font-semibold', key: 'micartaya.stack' },
        { selector: '#micartaya .rounded-3xl.border-dashed h3', key: 'micartaya.next' },
        { selector: '#micartaya .rounded-3xl.border-dashed p', key: 'micartaya.nextText' },
        { selector: '#micartaya details summary', key: 'micartaya.schema' },
        { selector: '#micartaya details pre', key: 'micartaya.schemaContent', type: 'text' },
        { selector: '#orderya p.text-xs.font-semibold', key: 'orderya.label' },
        { selector: '#orderya h2', key: 'orderya.title' },
        { selector: '#orderya article p:nth-of-type(1)', key: 'orderya.paragraph1', type: 'html' },
        { selector: '#orderya article p:nth-of-type(2)', key: 'orderya.paragraph2', type: 'html' },
        { selector: '#orderya article h3.text-sm.font-semibold', key: 'orderya.keyFeatures' },
        { selector: '#orderya article ul li:nth-child(1)', key: 'orderya.bullets.first', type: 'html' },
        { selector: '#orderya article ul li:nth-child(2)', key: 'orderya.bullets.second', type: 'html' },
        { selector: '#orderya article ul li:nth-child(3)', key: 'orderya.bullets.third', type: 'html' },
        { selector: '#orderya aside h3.text-sm.font-semibold', key: 'orderya.stack' },
        { selector: '#orderya .rounded-3xl.border-dashed h3', key: 'orderya.status.title' },
        { selector: '#orderya .rounded-3xl.border-dashed p', key: 'orderya.status.description' },
        { selector: '#orderya details summary', key: 'orderya.schema' },
        { selector: '#orderya details pre', key: 'orderya.schemaContent', type: 'text' },
        ...
        { selector: '#ponme p.text-xs.font-semibold', key: 'ponme.label' },
        { selector: '#ponme h2', key: 'ponme.title' },
        { selector: '#ponme article p:nth-of-type(1)', key: 'ponme.paragraph1', type: 'html' },
        { selector: '#ponme article p:nth-of-type(2)', key: 'ponme.paragraph2', type: 'html' },
        { selector: '#ponme h3.text-sm.font-semibold', key: 'ponme.impact' },
        { selector: '#ponme article ul li:nth-child(1)', key: 'ponme.bullets.first', type: 'html' },
        { selector: '#ponme article ul li:nth-child(2)', key: 'ponme.bullets.second', type: 'html' },
        { selector: '#ponme article ul li:nth-child(3)', key: 'ponme.bullets.third', type: 'html' },
        { selector: '#ponme aside h3.text-sm.font-semibold', key: 'ponme.stack' },
        { selector: '#ponme .rounded-3xl.border-dashed h3', key: 'ponme.next' },
        { selector: '#ponme .rounded-3xl.border-dashed p', key: 'ponme.nextText' },
        { selector: '#ponme details summary', key: 'ponme.schema' },
        { selector: '#ponme details pre', key: 'ponme.schemaContent', type: 'text' },
        ...
        { selector: '[data-direct-access-link="micartaya"]', key: 'directAccess.links.micartaya', type: 'html' },
        { selector: '[data-direct-access-link="orderya"]', key: 'directAccess.links.orderya', type: 'html' },
        ...
        { selector: '[data-direct-access-link="ponme"]', key: 'directAccess.links.ponme', type: 'html' },
    ],
};
